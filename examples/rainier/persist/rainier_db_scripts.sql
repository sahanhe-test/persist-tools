...
CREATE TABLE Workspace (
	...
	CONSTRAINT FK_WORKSPACE_BUILDING_0 FOREIGN KEY(buildingBuildingCode) REFERENCES Building(buildingCode),
	employeeEmpNo VARCHAR(191) NOT NULL,
	CONSTRAINT FK_WORKSPACE_EMPLOYEE_0 FOREIGN KEY(employeeEmpNo) REFERENCES Employee(empNo),
...
CREATE TABLE Employee (
	...
	CONSTRAINT FK_EMPLOYEE_DEPARTMENT_0 FOREIGN KEY(departmentDeptNo) REFERENCES Department(deptNo),
	PRIMARY KEY(empNo)
);
